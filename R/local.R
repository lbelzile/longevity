...
# #' @keywords internal
# #' @param type string giving the sampling frame, either \code{ltrt} for interval truncated data or \code{ltrc} for left-truncated right-censored observations
# #' @param lower lower bound under which data are censored or left-truncated
# #' @param upper upper bound beyond which observations are right-censored
# local_elife <- function(time,
#                         time2,
#                         event,
...
# #'   ab <- as.logical(I(dat > lower)*I(ltrunc < upper))
