...
Parametric models for excess lifetime (exponential, Gompertz, Weibull, generalized Pareto, extended generalized Pareto), with
...
The package will also include tools for esitmation of the nonparametric hazard estimates of Turnbull (1978) with pointwise confidence intervals.
