...
- [x] score tests for piecewise generalized Pareto distribution, extending Northrop and Coleman (2014)
...
- C++ implementation of the nonparametric MLE for the distribution function of Turnbull (1976)
