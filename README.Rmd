...
- [x] Remove Kolmogorov-Smirnov test (depending on whether it makes sense given null distribution)
...
- [x] Check all plots type are produced with both base **R** and `ggplot2`, and ellipsis works as expected
...
- [x] Root out data sets that cannot go on CRAN (with accompanying examples)
- [ ] Submit to the CRAN
